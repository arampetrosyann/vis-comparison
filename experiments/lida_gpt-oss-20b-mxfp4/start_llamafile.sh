...
MODEL_PATH="${LLAMAFILE_MODEL_PATH:-$SCRIPT_DIR/models/gpt-oss-20b-mxfp4.llamafile}"
SERVED_MODEL="${LIDA_MODEL:-gpt-oss-20b-mxfp4}"
HOST="${LLAMAFILE_HOST:-0.0.0.0}"
PORT="${LLAMAFILE_PORT:-8000}"
API_KEY="${LLAMAFILE_API_KEY:-}"
API_PREFIX="${LLAMAFILE_API_PREFIX:-/v1}"
N_GPU_LAYERS="${LLAMAFILE_N_GPU_LAYERS:-20}"
