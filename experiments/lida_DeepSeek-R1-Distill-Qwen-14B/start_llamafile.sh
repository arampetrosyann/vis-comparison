...
MODEL_PATH="${LLAMAFILE_MODEL_PATH:-$SCRIPT_DIR/models/DeepSeek-R1-Distill-Qwen-14B-Q4_K_M.llamafile}"
SERVED_MODEL="${LIDA_MODEL:-DeepSeek-R1-Distill-Qwen-14B-Q4_K_M}"
...
CTX_SIZE="${LLAMAFILE_CTX_SIZE:-6000}"
